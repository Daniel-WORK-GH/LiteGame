...
namespace Lite
{
    public static class LiteUtil
    {
        ...
        public static float GetElapsedTimeMilliSeconds(GameTime gameTime)
        {
            return (float)gameTime.ElapsedGameTime.TotalMilliseconds;
        }

        public static float GetElapsedTimeSeconds(GameTime gameTime)
        {
